...
ros2 launch hand_controller demo13_lekiwi_part1_qai2dials.launch.py verbose:=False use_flask:=False use_imshow:=False x_t:=0.20 z_t:=0.20 | ros2 run hand_controller gtk_gui_node
