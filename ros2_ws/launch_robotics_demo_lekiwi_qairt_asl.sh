...
ros2 launch hand_controller demo13_lekiwi_part1_qai2asl.launch.py verbose:=False use_flask:=False use_imshow:=False x_t:=0.20 x_a:=0.0 x_b:=10.0 z_t:=0.20 z_a:=0.0 z_b:=2.0 threshold_detector_minscore:=0.6 threshold_landmark_confidence:=0.6 | ros2 run hand_controller gtk_gui_node
